...
<template lang="nunjucks">
  <c-main>
    <c-panel title="Colors">
      <p>Change text color or background color</p>
    ...
    <c-panel title="Spaces">
      <p>Space step is 5px, start from 0, end at 60px</p>
      <table class="table table--bordered table--stress">
        <thead>
          <tr>
            <th>Class</th>
            <th>Description</th>
